...
#define MAVLINK_MSG_ID_LED_CONTROL 182
...
#define MAVLINK_MSG_ID_182_LEN 5
#define MAVLINK_MSG_ID_182_MIN_LEN 5

#define MAVLINK_MSG_ID_LED_CONTROL_CRC 5
#define MAVLINK_MSG_ID_182_CRC 5
...
{
    return mavlink_msg_led_control_pack_status(system_id, component_id, _status, msg,  led_control->type, led_control->r, led_control->g, led_control->b, led_control->brightness);
}
