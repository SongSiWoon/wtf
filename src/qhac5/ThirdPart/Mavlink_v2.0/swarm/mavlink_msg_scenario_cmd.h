...
#define MAVLINK_MSG_ID_SCENARIO_CMD 181
...
#define MAVLINK_MSG_ID_181_LEN 50
#define MAVLINK_MSG_ID_181_MIN_LEN 50
...
static inline uint16_t mavlink_msg_scenario_cmd_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float param1, float param2, float param3, uint32_t param4, uint8_t target_system, uint8_t cmd, const uint8_t *param5)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_scenario_cmd_pack_status(uint8_t system_id, uint8_t component_id, mavlink_status_t *_status, mavlink_message_t* msg,
                               float param1, float param2, float param3, uint32_t param4, uint8_t target_system, uint8_t cmd, const uint8_t *param5)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SCENARIO_CMD_LEN];
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_SCENARIO_CMD_MIN_LEN, MAVLINK_MSG_ID_SCENARIO_CMD_LEN, MAVLINK_MSG_ID_SCENARIO_CMD_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_SCENARIO_CMD_MIN_LEN, MAVLINK_MSG_ID_SCENARIO_CMD_LEN);
#endif
}
...
{
    return mavlink_msg_scenario_cmd_pack(system_id, component_id, msg, scenario_cmd->param1, scenario_cmd->param2, scenario_cmd->param3, scenario_cmd->param4, scenario_cmd->target_system, scenario_cmd->cmd, scenario_cmd->param5);
}
...
{
    return mavlink_msg_scenario_cmd_pack_chan(system_id, component_id, chan, msg, scenario_cmd->param1, scenario_cmd->param2, scenario_cmd->param3, scenario_cmd->param4, scenario_cmd->target_system, scenario_cmd->cmd, scenario_cmd->param5);
}

/**
 * @brief Encode a scenario_cmd struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
 ...
 * @param scenario_cmd C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_scenario_cmd_encode_status(uint8_t system_id, uint8_t component_id, mavlink_status_t* _status, mavlink_message_t* msg, const mavlink_scenario_cmd_t* scenario_cmd)
{
    return mavlink_msg_scenario_cmd_pack_status(system_id, component_id, _status, msg,  scenario_cmd->param1, scenario_cmd->param2, scenario_cmd->param3, scenario_cmd->param4, scenario_cmd->target_system, scenario_cmd->cmd, scenario_cmd->param5);
}
...
static inline void mavlink_msg_scenario_cmd_send(mavlink_channel_t chan, float param1, float param2, float param3, uint32_t param4, uint8_t target_system, uint8_t cmd, const uint8_t *param5)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SCENARIO_CMD_LEN];
    _mav_put_float(buf, 0, param1);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_scenario_cmd_send(chan, scenario_cmd->param1, scenario_cmd->param2, scenario_cmd->param3, scenario_cmd->param4, scenario_cmd->target_system, scenario_cmd->cmd, scenario_cmd->param5);
#else
 ...
 */
static inline void mavlink_msg_scenario_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float param1, float param2, float param3, uint32_t param4, uint8_t target_system, uint8_t cmd, const uint8_t *param5)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
