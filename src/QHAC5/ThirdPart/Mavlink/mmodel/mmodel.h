/** @file
 *  @brief MAVLink comm protocol generated from mmodel.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_MMODEL_H
#define MAVLINK_MMODEL_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_MMODEL.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
typedef enum SCENARIO_CMD_ENUM
{
   ...
   SCENARIO_CMD_SET_CONFIGS=5, /*  set vairous configurations param1: offset pos x, param2: offset pos y, param5: scenario file name  | */
